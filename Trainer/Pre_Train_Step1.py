...
class Pre_trainer(object):
    def __init__(self, model, optimizer, dataloader, graph, args,args_other=None):
        ...
        self.step_1_encoder_path = os.path.join(self.args.step_1_encoder_dir, self.args.dataset, 'encoder_step1.pth')
    ...
    def train(self):
        ...
        # test
        if os.path.isdir(os.path.join(self.args.step_1_encoder_dir, self.args.dataset)) == False:
            os.makedirs(os.path.join(self.args.step_1_encoder_dir, self.args.dataset), exist_ok=True)
        print('step_1 pretrain best encoder mode saved to {}'.format(self.step_1_encoder_path))

        torch.save(save_dict, self.step_1_encoder_path)
...
def St_ssl_encoder_train(args):
    ...
    best_path= trainer.step_1_encoder_path
    print(best_path)
