...
from Trainer.Pre_Train_Step1 import St_ssl_encoder_train, ST_pre
...
class UMSST(object):
    ...
    def __init__(self):
        ...
        self.seed = [31, 15, 75, 87, 53]  # bike2
        ...
        if args.set_attenuation:
            ...
            for i in range(9):
                ...
                for j in range(len(self.seed)):
                    ...
                    # Pretrain_step1
                    if not os.path.exists(os.path.join(self.args.step_1_encoder_dir,self.args.dataset,
                                    'encoder_step1.pth')):
                        print(os.path.join(self.args.step_1_encoder_dir,self.args.dataset,
                                    'encoder_step1.pth'))
                        _, pre_path, pre_model, _ = St_ssl_encoder_train(args)

                    else:
                        pre_path = os.path.join(self.args.step_1_encoder_dir,self.args.dataset,
                                    'encoder_step1.pth')
                        pre_model = ST_pre(args).to(args.device)
                    ...
                    # Pretrain_step2
                    if  not os.path.exists(os.path.join(self.args.step_2_encoder_dir, self.args.dataset,
                        ...
                        best_path = os.path.join(self.args.step_2_encoder_dir, self.args.dataset,
                                    f'{self.args.step_1}+_{self.args.step_2}_{args.attenuation}_{args.attenuation_rate}_encoder_step2.pth')
...
if __name__ == '__main__':
    ...
    # print(args1.set_attenuation)
    configs['set_attenuation'] = args1.set_attenuation
    configs['step_1'] = args1.step_1
    configs['step_2'] = args1.step_2
